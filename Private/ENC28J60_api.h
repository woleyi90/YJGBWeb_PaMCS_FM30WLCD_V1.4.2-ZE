 ...
 * Filename  : ENc28j60.h
 *
 * Function  : Reference head file for "ENC28J60" library.
 *
 ...
 *           : Mr. Liangbao Fan
 *
 * Check In  : $Date: 2013-05-11 11:26:49 +0800 (鍛ㄥ叚, 11 浜旀湀 2013) $
 *           : $Author: flb $
 * Revision  : $Revision: 8 $
 *
...
#define RXSTOP_INIT  	(0x1FFF-3000-1)	//接收buffer终止位置
#define TXSTART_INIT  	(0x1FFF-3000)	//发送buffer的起始位置
